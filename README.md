...
The file shared via cloud storage: VEDAI
Link: https://pan.baidu.com/s/1KGiKzpBfvh3XMZxoyNYq-A
Extraction code: gvrs
...
```bash
python -m venvRemote_SensingRemote888
sourceRemote_SensingRemote888/bin/activate  # On Windows:Remote_SensingRemote888\Scripts\activate
```
